...
\institute[]{\footnotesize ^{\dagger}$European Research University (ERUNI)$
\\ \vspace{1cm}
\textit{Research Seminar Series of the IOS Economics Department}} 
...
\begin{frame}{{Divided city of Cieszyn (PL) \& Český Těšín (CZ)}}
  ...
  \subcaptionbox{In 1910 - one (united) city}{\includegraphics[scale=0.18]{1.jpg}}&
  \subcaptionbox{In 1950 - divided \& borders}{\includegraphics[scale=0.25]{Screenshot 2022-11-29 at 16.01.44.png}}\\
  \hline
  \subcaptionbox{In 2005 - still border controls}{\includegraphics[scale=0.2]{AdobeStock_83908494-scaled-pkk4j6s2slao3i14bvueq4otuyttwx4fb94xybh6e8-pkk4jw5px49esz097otc3ga9wdcqoqx6eqr1wsfjq8.jpeg}}&
  \subcaptionbox{In 2008 - free movement}{\includegraphics[scale=0.1]{4d81091f37a44_o_xlarge.jpg}}
  \end{tabular}
...
\node (n1) at (0,0){\includegraphics[scale=0.2]{fi.png}}; 
